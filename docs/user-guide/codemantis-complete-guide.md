...
<!-- Date: March 2026 | App Version: 0.9.1 -->

# CodeMantis -- Complete User Guide

> This guide covers every feature, every button, every setting, and every keyboard shortcut in CodeMantis v0.9.1. It was generated by reading the application's source code -- every description matches the actual implementation.
