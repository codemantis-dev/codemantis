...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git_graph::get_branch_graph,
            commands::git_graph::list_branches,
            commands::git_graph::get_upstream_status,
            commands::git_graph::get_conflict_state,
            commands::git_write::create_branch,
            commands::git_write::switch_branch,
            commands::git_write::switch_branch_preview,
            commands::git_write::git_commit,
            commands::git_write::delete_branch,
            commands::git_write::delete_branch_preview,
            commands::git_write::merge_branch,
            commands::git_write::merge_branch_preview,
            commands::git_write::abort_merge,
            commands::git_write::git_pull,
            commands::git_write::git_push,
            commands::git_write::git_push_preview,
            commands::git_write::publish_branch,
            commands::git_write::undo_git_op,
