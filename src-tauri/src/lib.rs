...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::taskboard::save_task_board_state,
            commands::taskboard::load_task_board_state,
            ...
            commands::taskboard::list_all_task_plans,
            commands::taskboard::list_project_task_plans,
            commands::taskboard::delete_task_plan_cmd,
            commands::taskboard::archive_task_plan_cmd,
