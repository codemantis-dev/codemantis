import { Settings, Terminal, Zap, Layers, ScrollText, MessageSquare, Keyboard, BarChart3, Globe, PenTool, Database, Shield, Rocket, Cpu, Brain, Users } from "lucide-react";
import type { ChangelogProvider } from "../../../types/settings";

export type SettingsTab = "general" | "agents" | "terminal" | "quick-commands" | "ai-providers" | "changelog" | "assistant" | "shortcuts" | "api-logs" | "preview" | "task-board" | "session-logs" | "super-bro" | "self-drive" | "duo" | "recall";
...
export const NAV_ITEMS: { id: SettingsTab; label: string; icon: typeof Settings }[] = [
  ...
  { id: "duo", label: "Duo-Coding", icon: Users },
