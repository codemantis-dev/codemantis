...
export default function ScaffoldProgress({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {!setupSessionId && <div className="flex-1" />}
      ...
      <div className="flex items-center justify-center gap-3 shrink-0 pb-2">
        {isFinished ? (
          ...
          <>
            ...
            <button
              onClick={onCancel}
              className="px-4 py-2 rounded-lg border border-border text-text-dim text-ui hover:text-text-secondary hover:bg-bg-elevated transition-colors"
            >
              Cancel
            </button>
          </>
